<table>
  ...
  <tr><td>
    ...
    <td>
      ...
      echo  CHtml::ajaxSubmitButton('<<',array('authitem/assign','assignTasks'=>1),$ajax,$data['assign']); ?>
      <?php
      $ajax =
          array(
          'type'=>'POST',
      ...
      echo  CHtml::ajaxSubmitButton('>>',array('authitem/assign','revokeTasks'=>1),$ajax,$data['revoke']); ?>
    </td>
    <td>
